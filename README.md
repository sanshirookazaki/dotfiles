...
brew install vim wget coreutils peco ghq ccat highway kubernetes-cli kubectx kube-ps1 stern skaffold derailed/k9s/k9s c-bata/kube-prompt/kube-prompt docui tektoncd-cli tfenv pandoc fzf lazygit gotop highlight zsh-syntax-highlighting dive tig bat iproute2mac qemu
